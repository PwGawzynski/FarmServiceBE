...
export class MailingService {
     ...
     */
    public async sendMail({to,template, subject, context, attachments} : SendMailSettingsObject) {
        ...
        this.mailerService
            ...
            .catch(() => {
                printWarnToConsole("Error occurred when trying to send email", "Mailing-Service");
            });
        return {
